...
static_params="-c:a aac -ar 48000 -c:v h264 -preset ultrafast -profile:v main -crf 20 -sc_threshold 0"
...
ffmpeg -threads 32 ${misc_params} -i ${source} ${cmd} -progress progress-$3.txt
